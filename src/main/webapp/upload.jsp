...
<%
	...
	try{  
	    ...
	    {  
	    	  String captureFileName =request.getParameter("captureFileName");
	    	  
		      DiskFileItemFactory dff = new DiskFileItemFactory();  
		      dff.setRepository(new File("e://store_image"));
		      ...
		      while(fii.hasNext()){  
		        ...
		        if(!fis.isFormField()){	        	
		            ...
		            BufferedOutputStream outs = new BufferedOutputStream(new FileOutputStream(new File("e:\\store_image\\"+ captureFileName)));  
