		...
		<div class="segment">
			<div style="padding-left: 10px; padding-right: 10px;">
				<table class="table datatable table-bordered  table-hover" id="datatable">
					<thead>
						<tr>
							<th class='text-center' data-col-class='text-center' data-width='10%' class='text-primary'>附件名称</th>
							<th class='text-center' data-col-class='text-center' data-width='10%' class='text-primary'>附件条码</th>
						</tr>
					</thead>
					<!-- 同步表格 -->
					<tbody>
						...
						<c:forEach items="${list}" var="clothes">
							<tr>
							    <td class='text-center'>${clothes.attachName}</td>
							    <td class='text-center'>${clothes.attachBarCode}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
