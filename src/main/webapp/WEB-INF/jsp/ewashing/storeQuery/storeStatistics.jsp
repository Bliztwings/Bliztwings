...
<script type="text/javascript">
	...
	function query(){
	    ...
	    location.href = "<%=basePath%>/orderQuery/storeStatistics?"+params;
	}
...
<body id="content">
	...
	<!-- 搜索条件 -->
	<form id="formId" name="formId" class="form-horizontal" role="form" method='get' action="<%=basePath%>/orderQuery/storeStatistics">
				...
				<table class="table datatable table-bordered  table-hover" id="datatable">
					<thead>
						<tr>
							...
							<th class='text-center' data-col-class='text-center' data-width='10%'>订单量</th>
							<th class='text-center' data-col-class='text-center' data-width='10%'>衣服量</th>
							<th class='text-center' data-col-class='text-center' data-width='10%'>现金支付金额</th>
							<th class='text-center' data-col-class='text-center' data-width='10%'>会员卡支付金额</th>
							<th class='text-center' data-col-class='text-center' data-width='10%'>未支付金额</th>
							<th class='text-center' data-col-class='text-center' data-width='10%'>充值金额 </th>
						</tr>
					</thead>
					<!-- 同步表格 -->
					<tbody>
						...
						<c:forEach items="${page.list}" var="order">
							<tr>
							    ...
							    <td>${order.receiveCount}</td>
							    <td>${order.cashAmount}</td>
							    <td>${order.memberCardAmount}</td>
							    <td>${order.noPayAmount}</td>
							    <td>${order.rechargeAmount}</td>
							</tr>
						</c:forEach>
					</tbody>
