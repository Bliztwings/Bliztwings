					...
					<table class="table table-bordered  table-hover" id="datatable">
						...
						<tbody>
							...
							<c:forEach items="${list}" var="handon">
								<tr>
									<td class='text-center'><input type="checkbox" name="checkbox" value="${handon.id}#${handon.storeName}#${handon.orderCode}#${handon.clothesCount}"/></td>
		...
		<div style="padding-left: 10px; margin-top: 5px;margin-bottom: 10px;">
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					...
					<td width="60px" align="left" style="position:relative;padding-left: 10px;font-size: 12">隔架号:</td>
					<td align="left" id="handonNoHtml">
						<select id="handonNo" class="form-control validate[required,maxSize[16]] required" style="width: 80px;">
							<option value="0">隔架号</option>
						</select>
					</td>
					
					<td align="left" style="position:relative;padding-left: 10px;">
						<button class="btn btn-primary" type="button" id="transLogQueryBtn" onclick="handon()" style="margin-right: 10px;">上  挂</button>
					</td>
