...
<c:if test="${resultCode == 0}">
  ...
  <article>
    ...
    <section id='form' class="page-section" >
      	<div class='panel' style="padding-left: 10px">
        <div class='panel-body' style="padding-left: 10px">
        <form id="formId" name="formId" class="form-horizontal" role="form" method='post' action="<%=basePath%>/memberCard/doRefund">
		    ...
		    <div class="input-group" style="margin-bottom: 0px;">
			  <span class="input-group-addon" style="width:100px;text-align: right;" >现金退款：</span>
		      	<input id="cashAmount" name="cashAmount" value="" type="text" class="form-control" style="width: 200px;"/>
		      <span class="glyphicon glyphicon-star"></span>
		      <span class="input-group-addon" style="width:100px;text-align: right;" >赠送退款：</span>
		        <input id="givedAmount" name="givedAmount" value="" type="text" class="form-control" style="width: 200px;"/>
		      <span class="glyphicon glyphicon-star"></span>
		    </div>
		    <div class="input-group" style="margin-bottom: 0px;">
			    <span class="input-group-addon" style="width:100px;text-align: right;">退款方式：</span>
