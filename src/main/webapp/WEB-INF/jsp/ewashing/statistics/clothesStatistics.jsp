...
<script type="text/javascript">
	...
	function choose(type){
	    ...
	    location.href = "<%=basePath%>/statistics/clothesStatistics?"+params;
	}
...
<body id="content">
	...
	<!-- 搜索条件 -->
	<form id="formId" name="formId" class="form-horizontal" role="form" method='get' action="<%=basePath%>/statistics/clothesStatistics">
		<input type="hidden" name="tabType" id ="tabType"/>
		<div style="position: relative;margin-left: 10px;width: 58%;">
			<ul class="nav nav-tabs" id="myTab" >
				<li id="choose1" class="active"><a href="#identifier" data-toggle="tab" onclick="choose(3)">入厂衣服</a></li>
				<li id="choose2"><a href="#identifier" data-toggle="tab" onclick="choose(12)">上挂衣服</a></li>
				<li id="choose3"><a href="#identifier" data-toggle="tab" onclick="choose(13)">出厂衣服</a></li>
			</ul>
		</div>
				...
				<table class="table  table-bordered  table-hover" id="datatable">
					<thead>
						<tr>
							...
							<th class='text-center' data-col-class='text-center' data-width='10%'>衣物当前状态</th>
					...
					<tfoot>
						...
						<jsp:include page="../../inc/page_PageHelper.jsp">
								<jsp:param name="path" value="/statistics" />
						</jsp:include></td>
					</tfoot>
