...
<script type="text/javascript">
	...
	function query(){
	    ...
	    location.href = "<%=basePath%>/statistics/statisticalAnalysis?"+params;
	}
...
<body id="content">
	...
	<!-- 搜索条件 -->
	<form id="formId" name="formId" class="form-horizontal" role="form" method='get' action="<%=basePath%>/statistics/statisticalAnalysis">
		<div  style="padding-left: 10px; margin-top: 5px;">
			<table cellpadding="0" cellspacing="0" border="0" width="100%" >
				<tr>
					<%-- <td width="10%">
						<div class="input-group" >
							<span class="input-group-addon" style="width: 50px; text-align: left;">门店：</span> 
					...
					<td width="10%">
						<div class="input-group" >
							<span class="input-group-addon"
								style="width: 50px; text-align: left;">统计时间：</span> 
								<input id="beginDate" name="beginDate" value="${beginDate}"
								type="text"  class="form-control form-datetime" placeholder="统计时间" 
				...
				<table class="table  table-bordered  table-hover" id="datatable">
					<thead>
						<tr>
							...
							<th class='text-center' data-col-class='text-center' data-width='10%'>收款金额</th>
						</tr>
					</thead>
					<!-- 同步表格 -->
					<tbody>
