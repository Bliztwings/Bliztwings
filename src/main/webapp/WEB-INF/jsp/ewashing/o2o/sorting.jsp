...
<script type="text/javascript">
	...
	// 查询水洗唛数据
	function QueryShuiXiMai(queryKey)
	{
		var queryKey =$("#queryKey").val();
		var mobilePhone =$("#mobilePhone").val();
		...
		$.ajax({
			type: 'GET',
			url: '<%=basePath%>/sorting/queryShuiXiMai?queryKey='+queryKey,
				...
				<tr>
					...
					<td width="20px" align="left">
						<div class="input-group" style="padding-left: 10px;">
							...
							<button class="btn btn-primary" type="button" id="button123" onclick="QueryShuiXiMai()" style="margin-right: 10px;">打印水洗唛</button>
						</div>
					</td>
				</tr>
