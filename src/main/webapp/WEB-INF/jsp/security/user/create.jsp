  ...
  <article>
    <section id='form' class="page-section" >
      <div class='panel' style="padding-left: 10px">
        ...
        <form id="formId" name="formId" class="form-horizontal" role="form" method='post' action="<%=basePath%>/user/create">

   <div class="input-group" style="margin-bottom: 10px;">
      <span class="input-group-addon" style="width:150px;text-align: right;" >用户名：</span>
        <input id="username" name="username" value="${securityUser.username }" type="text" 
        class="form-control validate[required,maxSize[32]] required" placeholder="" style="width: 300px;"/>
      <span class="glyphicon glyphicon-star"></span>
    </div>
    
   <div class="input-group" style="margin-bottom: 10px;">
      <span class="input-group-addon" style="width:150px;text-align: right;">登录密码：</span>
        <input id="password" name="password" value="${securityUser.password }" type="password" 
        class="form-control validate[required,maxSize[32]] required" placeholder="" style="width: 300px;"/>
      <span class="glyphicon glyphicon-star"></span>
    </div>
    
   <div class="input-group" style="margin-bottom: 10px;">
      <span class="input-group-addon" style="width:150px;text-align: right;">真实姓名：</span>
        <input id="realname" name="realname" value="${securityUser.realname }" type="text" 
        class="form-control validate[required,maxSize[32]] required" placeholder="" style="width: 300px;"/>
      <span class="glyphicon glyphicon-star"></span>
    </div>
    
    <div class="input-group" style="margin-bottom: 10px;">
      <span class="input-group-addon" style="width:150px;text-align: right;">电话号码：</span>
        <input id="phone" name="phone" value="${securityUser.phone }" type="text" 
        class="form-control validate[custom[phone],maxSize[50]]" placeholder="" style="width: 300px;"/>
      <span class="glyphicon glyphicon-star"></span>
    </div>
    
   <div class="input-group" style="margin-bottom: 10px;">
      <span class="input-group-addon" style="width:150px;text-align: right;">邮箱：</span>
        <input id="email" name="email" value="${securityUser.email }" type="text" 
        class="form-control validate[custom[email],maxSize[50]]" placeholder="" style="width: 300px;"/>
      <span class="glyphicon glyphicon-star"></span>
    </div>
    ...
    <div class="input-group" style="margin-bottom: 10px;">
      <span class="input-group-addon" style="width:150px;text-align: right;">选择用户类型：</span>
      		<select id="userType" name="userType" class="form-control validate[required] required" style="width: 300px;">
                ...
                <option value="2">工厂用户</option>
                <option value="3">普通管理员</option>
                <option value="4">o2o管理员</option>
            </select>
      <span class="glyphicon glyphicon-star"></span>
    </div>
