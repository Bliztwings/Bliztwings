  ...
  <article>
    <section id='form' class="page-section" >
      <div class='panel' style="padding-left: 10px">
        ...
        <form id="formId" name="formId" class="form-horizontal" role="form" method='post' action="<%=basePath%>/role/update">
		<input type='hidden' name='id' id='id' value='${securityRole.id }'  />
   ...
   <div class="input-group" style="margin-bottom: 10px;">
      <span class="input-group-addon" style="width:150px;text-align: right;">说明：</span>
        <textarea id="description" name="description" type="text" class="form-control validate[maxSize[96]]" placeholder="备注说明" style="width: 300px;">${securityRole.description}</textarea>
      <span class="glyphicon glyphicon-star"></span>
    </div> 
